...
export class InitialSchema1755846070272 implements MigrationInterface {
  name = 'InitialSchema1755846070272';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`users\` (\`id\` varchar(36) NOT NULL, \`fullName\` varchar(100) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`role_id\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`pre_orders\` (\`id\` varchar(36) NOT NULL, \`sku\` varchar(100) NOT NULL, \`quantity\` int UNSIGNED NOT NULL, \`created_by\` varchar(255) NOT NULL, \`status\` varchar(20) NOT NULL DEFAULT 'active', \`poNumber\` varchar(255) NULL, \`length\` varchar(10) NULL, \`width\` varchar(10) NULL, \`radius\` varchar(10) NULL, \`skirt\` varchar(100) NULL, \`taper\` varchar(255) NULL, \`foamDensity\` varchar(100) NULL, \`stripInsert\` varchar(255) NULL, \`shape\` varchar(255) NULL, \`materialNumber\` varchar(255) NULL, \`materialType\` varchar(255) NULL, \`materialColor\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`inbound\` (\`id\` varchar(36) NOT NULL, \`poNumber\` varchar(255) NULL, \`containerNumber\` varchar(255) NULL, \`etd\` date NULL, \`eta\` date NULL, \`shipped\` varchar(255) NULL, \`offloadedDate\` date NULL, \`sku\` varchar(255) NOT NULL, \`vendorDescription\` text NULL, \`length\` varchar(10) NULL, \`width\` varchar(10) NULL, \`radius\` varchar(10) NULL, \`skirt\` varchar(10) NULL, \`taper\` varchar(255) NULL, \`foamDensity\` varchar(10) NULL, \`stripInsert\` varchar(255) NULL, \`shape\` varchar(255) NULL, \`materialNumber\` varchar(255) NULL, \`materialType\` varchar(255) NULL, \`materialColor\` varchar(255) NULL, \`quantity\` bigint NULL, \`preBookedQuantity\` bigint NULL DEFAULT '0', \`production_batch_id\` varchar(255) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, INDEX \`idx_inbound_sku\` (\`sku\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_762b3aa9a28173d75b5c0d1f48\` ON \`custom_orders\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_35dc2605d99cb2c46fc0ef9c5b\` ON \`custom_orders\``,
    );
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_3b32dd2b00eb309ca80cfa80c3\` ON \`webhook_logs\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_0097a33e4b2083268c615ea024\` ON \`webhook_logs\``,
    );
